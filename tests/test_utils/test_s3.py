...
def test_dt_to_lexicographic_date_dash_s3_prefix():
    dt = datetime.datetime(2023, 4, 11, 21, 2, 39, 4166)
    expected_lexicographic_dash_s3_prefix = "2023-04-11"
    assert dt_to_lexicographic_date_dash_s3_prefix(dt) == expected_lexicographic_dash_s3_prefix
